...
export default function Profile() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-200 to-blue-100 dark:from-gray-900 dark:to-blue-900/20 flex items-center justify-center p-4">
        <Card className="w-full max-w-md text-center shadow-xl">
          <CardHeader className="space-y-4">
            <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${getDefaultAvatarColor('')} flex items-center justify-center text-white text-2xl font-bold mx-auto`}>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="flex items-center space-x-6">
              <div className="relative">
                <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${getDefaultAvatarColor(user.name)} flex items-center justify-center text-white text-3xl font-bold shadow-lg border-4 border-white dark:border-gray-800 relative overflow-hidden`}>
      {user.avatar ? (
        <img 
          src={user.avatar} 
          alt="Avatar" 
